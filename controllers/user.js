...
exports.saveAddress = async (req, res) => {
  const userAddress = await User.findOneAndUpdate(
    ...
    { mobile: req.body.mobile,pin:req.body.pin,address:req.body.address }
  ).exec();
...
exports.createOrder=async (req,res)=>{
  ...
  let updated= await Product.bulkWrite(options,{});
...
exports.getOrder= async(req,res)=>{
  ...
  let order=await Order.find({orderdBy:user._id}).populate("products.product orderdBy").exec();
  res.json(order);
}
